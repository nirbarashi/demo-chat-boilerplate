...
const InputBox = ({ userInfo: {username, avatar}, setUsername, message, setMessage, sendMessage }) => {
	return (
		<div className="message-box">
			...
			<input className="message-box-input" type="text" value={message} onKeyPress={event => event.key === 'Enter' ? sendMessage(event) : null} onChange={(event) => setMessage(event.target.value)} placeholder="Type your message here..." />
