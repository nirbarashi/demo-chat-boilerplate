...
const InputBox = ({ userInfo: {username, avatar}, setUserInfo, message, setMessage, sendMessage }) => {
	return (
		<div className="message-box">
			<Avatar avatar={avatar} />
			<input className="" type="text" value={username} onChange={(event) => setUserInfo(event.target.value.trim())} placeholder="Enter your name here..." />
